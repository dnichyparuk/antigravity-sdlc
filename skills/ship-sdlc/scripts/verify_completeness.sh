...
if [ ! -f "$EXECUTE_STATE_SCRIPT" ] && [ -f "$SDLC_ROOT/plugins/lift-sdlc/scripts/state/execute.js" ]; then
  EXECUTE_STATE_SCRIPT="$SDLC_ROOT/plugins/lift-sdlc/scripts/state/execute.js"
fi
