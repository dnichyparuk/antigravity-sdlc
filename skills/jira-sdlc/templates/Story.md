...
- [ ] [Error handling / edge case criterion]
- [ ] [Permission / access control criterion if relevant]
- [ ] [Performance or security criterion if relevant]
...
1. **Prerequisites:** [Setup, test data, environment requirements]
2. **Steps:**
   1. [Step 1]
   2. [Step 2]
   3. [Step 3]
